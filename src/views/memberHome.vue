            ...
            <div class="out-button">
                <el-dropdown >
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item class="navigation-text" @click.native="memberInformation">公司信息</el-dropdown-item>
            ...
            <el-aside width="200px">
                <el-menu router
                    ...
                    <el-submenu index="1">
                        ...
                        <el-menu-item index="/memberHistory">交易记录</el-menu-item>
                        <el-menu-item index="/memberBorrow">请求借款</el-menu-item>
                    </el-submenu>
                    <el-submenu index="2">
                        <template slot="title"><i class="el-icon-s-check"></i>购买</template>
                        <el-menu-item index="/financialProducts">理财产品推荐</el-menu-item>
                        <el-menu-item index="/productheld">拥有理财产品</el-menu-item>
                    </el-submenu>
                </el-menu>
            </el-aside>
            <!--            右侧内容主体-->
